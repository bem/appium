...
var Simulator = function (opts) {
  ...
  // make minor version (7.0) from patch version (7.0.3) to use in paths, primarily
  var floatVer = parseFloat(this.platformVer),
      intVer = parseInt(this.platformVer, 10);
  this.platformMinorVer = floatVer > intVer ? String(floatVer) : intVer + '.0';
};
...
Simulator.prototype.getSafari7Dirs = function () {
  return this.getApp7Dirs(["MobileSafari.app", "Appium-MobileSafari-" + this.platformMinorVer + ".app"]);
};
...
Simulator.prototype.prepareBuiltInApp = function (appName, tmpDir, cb) {
  ...
  var newAppDir = path.resolve(tmpDir, 'Appium-' + appName + '-' + this.platformMinorVer + '.app');
...
Simulator.prototype.getBuiltInAppDir = function (cb) {
  xcode.getPath(function (err, xcodeDir) {
    ...
    var appDir = path.resolve(xcodeDir, "Platforms/iPhoneSimulator.platform/" +
                              ...
                              this.platformMinorVer + ".sdk/Applications/");
